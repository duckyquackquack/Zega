namespace Zega.Cpu
{
    public partial class Z80
    {
        ...
        public Z80(IMemory memory, Registers? registers = null)
        {
            ...
            _displacementInstructionGroups = new List<IDisplacementInstructionGroup>
            {
                new DDCBInstructionGroup(new Dictionary<byte, DisplacementInstruction>
                {
                    ...
                    { 0x80, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0x81, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0x82, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0x83, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0x84, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0x85, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0x86, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0x87, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0x88, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0x89, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0x8A, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0x8B, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0x8C, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0x8D, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0x8E, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0x8F, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0x90, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0x91, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0x92, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0x93, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0x94, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0x95, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0x96, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0x97, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0x98, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0x99, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0x9A, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0x9B, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0x9C, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0x9D, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0x9E, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0x9F, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0xA0, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0xA1, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0xA2, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0xA3, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0xA4, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0xA5, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0xA6, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0xA7, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0xA8, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0xA9, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0xAA, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0xAB, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0xAC, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0xAD, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0xAE, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0xAF, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0xB0, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0xB1, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0xB2, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0xB3, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0xB4, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0xB5, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0xB6, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0xB7, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0xB8, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0xB9, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0xBA, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0xBB, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0xBC, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0xBD, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0xBE, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0xBF, new DisplacementInstruction(ResetBIndexXD, TCycles.T443543) },
                    { 0xC0, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xC1, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xC2, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xC3, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xC4, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xC5, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xC6, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xC7, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xC8, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xC9, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xCA, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xCB, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xCC, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xCD, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xCE, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xCF, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xD0, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xD1, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xD2, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xD3, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xD4, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xD5, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xD6, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xD7, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xD8, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xD9, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xDA, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xDB, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xDC, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xDD, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xDE, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xDF, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xE0, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xE1, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xE2, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xE3, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xE4, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xE5, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xE6, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xE7, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xE8, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xE9, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xEA, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xEB, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xEC, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xED, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xEE, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xEF, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xF0, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xF1, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xF2, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xF3, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xF4, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xF5, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xF6, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xF7, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xF8, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xF9, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xFA, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xFB, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xFC, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xFD, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xFE, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) },
                    { 0xFF, new DisplacementInstruction(SetBIndexXD, TCycles.T443543) }
                }),
                new FDCBInstructionGroup(new Dictionary<byte, DisplacementInstruction>
                {
                    ...
                    { 0x80, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0x81, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0x82, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0x83, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0x84, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0x85, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0x86, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0x87, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0x88, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0x89, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0x8A, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0x8B, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0x8C, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0x8D, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0x8E, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0x8F, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0x90, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0x91, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0x92, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0x93, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0x94, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0x95, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0x96, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0x97, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0x98, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0x99, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0x9A, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0x9B, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0x9C, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0x9D, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0x9E, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0x9F, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0xA0, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0xA1, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0xA2, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0xA3, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0xA4, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0xA5, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0xA6, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0xA7, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0xA8, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0xA9, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0xAA, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0xAB, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0xAC, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0xAD, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0xAE, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0xAF, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0xB0, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0xB1, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0xB2, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0xB3, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0xB4, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0xB5, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0xB6, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0xB7, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0xB8, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0xB9, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0xBA, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0xBB, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0xBC, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0xBD, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0xBE, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0xBF, new DisplacementInstruction(ResetBIndexYD, TCycles.T443543) },
                    { 0xC0, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xC1, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xC2, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xC3, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xC4, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xC5, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xC6, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xC7, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xC8, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xC9, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xCA, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xCB, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xCC, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xCD, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xCE, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xCF, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xD0, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xD1, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xD2, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xD3, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xD4, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xD5, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xD6, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xD7, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xD8, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xD9, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xDA, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xDB, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xDC, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xDD, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xDE, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xDF, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xE0, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xE1, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xE2, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xE3, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xE4, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xE5, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xE6, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xE7, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xE8, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xE9, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xEA, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xEB, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xEC, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xED, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xEE, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xEF, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xF0, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xF1, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xF2, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xF3, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xF4, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xF5, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xF6, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xF7, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xF8, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xF9, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xFA, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xFB, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xFC, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xFD, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xFE, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) },
                    { 0xFF, new DisplacementInstruction(SetBIndexYD, TCycles.T443543) }
                })
            };
        ...
        public uint Step()
        {
            ...
            // Rather than search with .Any(), just check specifically for DD or FD since those are the only parent group prefixes
